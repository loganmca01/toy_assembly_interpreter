...
vm_gen: vm/vm_main.c vm/vm_parser.y vm/vm_parser.l vm/vm.h ast_functions.c vm/vm_parser_functions.c
		bison -ovm/vm_parser.tab.c -d vm/vm_parser.y -Wcounterexamples && \
		flex -ovm/vm_parser.lex.c vm/vm_parser.l && \
		cc -g -o $@ vm/vm_parser.tab.c vm/vm_parser.lex.c vm/vm_main.c ast_functions.c vm/vm_parser_functions.c -lm
